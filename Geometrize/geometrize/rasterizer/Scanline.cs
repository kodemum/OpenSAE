...
namespace geometrize.rasterizer {
	public class Scanline : global::haxe.lang.HxObject {
		...
		public static global::HaxeArray<object> trim(global::HaxeArray<object> scanlines, int w, int h) {
			if (( scanlines == null )) {
				throw ((global::System.Exception) (global::haxe.Exception.thrown("FAIL: scanlines != null")) );
			}
			
			int w1 = w;
			int h1 = h;
			global::haxe.lang.Function f = new global::geometrize.rasterizer.Scanline_trim_44__Fun(w1, h1);
			global::HaxeArray<object> ret = new global::HaxeArray<object>(new object[]{});
			{
				int _g = 0;
				int _g1 = scanlines.length;
				while (( _g < _g1 )) {
					int i = _g++;
					global::geometrize.rasterizer.Scanline elt = ((global::geometrize.rasterizer.Scanline) (scanlines.__a[i]) );
		...
		public static bool trimHelper(global::geometrize.rasterizer.Scanline line, int w, int h) {
			unchecked {
