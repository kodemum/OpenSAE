...
namespace geometrize.shape {
	public class Line : global::haxe.lang.HxObject, global::geometrize.shape.Shape {
		...
		public virtual global::HaxeArray<object> rasterize() {
			...
			global::HaxeArray<object> points = global::geometrize.rasterizer.Rasterizer.bresenham(this.x1, this.y1, this.x2, this.y2);
			{
				int _g = 0;
				while (( _g < points.length )) {
					object point = points[_g];
					 ++ _g;
					lines.push(new global::geometrize.rasterizer.Scanline(((int) (global::haxe.lang.Runtime.getField_f(point, "y", 121, true)) ), ((int) (global::haxe.lang.Runtime.getField_f(point, "x", 120, true)) ), ((int) (global::haxe.lang.Runtime.getField_f(point, "x", 120, true)) )));
				}
				
			}
			
			return global::geometrize.rasterizer.Scanline.trim(lines, this.xBound, this.yBound);
		}
