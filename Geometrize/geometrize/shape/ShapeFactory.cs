...
namespace geometrize.shape
{
    public class ShapeFactory
    {
        ...
        public static Shape create(int type, int xBound, int yBound, SymbolShapeOptions symbolOptions)
        {
            unchecked
            {
                switch (type)
        ...
        public static Shape randomShapeOf(int[] types, int xBound, int yBound, SymbolShapeOptions symbolOptions)
        {
