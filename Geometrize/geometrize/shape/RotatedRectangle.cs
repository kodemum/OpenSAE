	...
	public class RotatedRectangle : global::haxe.lang.HxObject, global::geometrize.shape.Shape {
		...
		public virtual global::HaxeArray<object> rasterize() {
			unchecked {
				...
				return global::geometrize.rasterizer.Scanline.trim(global::geometrize.rasterizer.Rasterizer.scanlinesForPolygon(new global::HaxeArray<object>(new object[]{new global::haxe.lang.DynamicObject(new int[]{}, new object[]{}, new int[]{120, 121}, new double[]{((double) (ulx) ), ((double) (uly) )}), new global::haxe.lang.DynamicObject(new int[]{}, new object[]{}, new int[]{120, 121}, new double[]{((double) (urx) ), ((double) (ury) )}), new global::haxe.lang.DynamicObject(new int[]{}, new object[]{}, new int[]{120, 121}, new double[]{((double) (brx) ), ((double) (bry) )}), new global::haxe.lang.DynamicObject(new int[]{}, new object[]{}, new int[]{120, 121}, new double[]{((double) (blx) ), ((double) (bly) )})})), this.xBound, this.yBound);
			}
		}
