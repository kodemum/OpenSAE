    ...
    public static class SymbolUtil
    {
        ...
        static SymbolUtil()
        {
            _symbols = new List<Symbol>()
            {
                ...
                new Symbol(241, "Circle", "Filled circle", SymbolGroup.FilledSymbols, SymbolFlag.FullySymmetric),
                new Symbol(242, "Triangle", "Filled equilateral triangle", SymbolGroup.FilledSymbols, SymbolFlag.HorizontallySymmetric),
                new Symbol(243, "Square", "Filled square", SymbolGroup.FilledSymbols, SymbolFlag.FullySymmetric),
                new Symbol(244, "Pentagon", "Filled pentagon", SymbolGroup.FilledSymbols, SymbolFlag.HorizontallySymmetric),
                new Symbol(245, "Hexagon", "Filled hexagon", SymbolGroup.FilledSymbols, SymbolFlag.VerticallySymmetric | SymbolFlag.HorizontallySymmetric),
                new Symbol(246, "Octagon", "Filled regular octagon", SymbolGroup.FilledSymbols, SymbolFlag.FullySymmetric),
                new Symbol(247, "Octagon2", "Filled octagon", SymbolGroup.FilledSymbols, SymbolFlag.FullySymmetric),
                ...
                new Symbol(251, "Rounded square", "Filled rounded square", SymbolGroup.FilledSymbols, SymbolFlag.FullySymmetric),
                ...
                new Symbol(255, "♥", "Filled heart", SymbolGroup.FilledSymbols, SymbolFlag.HorizontallySymmetric),
                new Symbol(256, "♦", "Filled diamond symbol", SymbolGroup.FilledSymbols, SymbolFlag.HorizontallySymmetric | SymbolFlag.VerticallySymmetric),
                new Symbol(257, "Cresent moon", "Filled cresent moon", SymbolGroup.FilledSymbols),
                new Symbol(258, "Gem", "Filled gem symbol (SG)", SymbolGroup.FilledSymbols, SymbolFlag.HorizontallySymmetric),
                new Symbol(259, "Drop", "Filled drop symbol", SymbolGroup.FilledSymbols, SymbolFlag.HorizontallySymmetric),
                new Symbol(260, "Half circle", "Filled half circle", SymbolGroup.FilledSymbols, SymbolFlag.HorizontallySymmetric),
                new Symbol(261, "Astroid", "Filled astroid shape", SymbolGroup.FilledSymbols, SymbolFlag.HorizontallySymmetric | SymbolFlag.VerticallySymmetric),
                new Symbol(262, "Capsule", "Filled stadium/capsule shape", SymbolGroup.FilledSymbols, SymbolFlag.HorizontallySymmetric | SymbolFlag.VerticallySymmetric),
                ...
                new Symbol(268, "Tear", "Filled tear", SymbolGroup.FilledSymbols, SymbolFlag.HorizontallySymmetric | SymbolFlag.VerticallySymmetric),
                ...
                new Symbol(349, "Line tip 4", SymbolGroup.LineSymbols, SymbolFlag.HorizontallySymmetric),
                new Symbol(350, "Line tip 5", SymbolGroup.LineSymbols, SymbolFlag.HorizontallySymmetric),
                new Symbol(351, "Line tip 6", SymbolGroup.LineSymbols, SymbolFlag.HorizontallySymmetric),
                new Symbol(352, "Line tip 7", SymbolGroup.LineSymbols, SymbolFlag.HorizontallySymmetric),
                new Symbol(353, "Circle segment 1", SymbolGroup.LineSymbols, SymbolFlag.VerticallySymmetric),
                new Symbol(354, "Circle segment 2", SymbolGroup.LineSymbols, SymbolFlag.VerticallySymmetric),
                new Symbol(355, "Circle segment 3", SymbolGroup.LineSymbols, SymbolFlag.VerticallySymmetric),
                new Symbol(356, "Circle segment 4", SymbolGroup.LineSymbols, SymbolFlag.VerticallySymmetric),
                ...
                new Symbol(681, "Game symbol 41", SymbolGroup.GameSymbols, SymbolFlag.FullySymmetric),
